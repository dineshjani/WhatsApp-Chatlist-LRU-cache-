...
const chat_names = ["Dinesh Jani", "Bhavnish sharma", "Mahaveer parjapat", "Kapil Jangid", "Ravindra Badiyasar", "Hardev", "Thakraram beniwal"];
...
class ChatHandler {
    ...
    createNode(id) {
        ...
        console.log("/public/avatar" + eval(1 + (id % chat_img_length)) + ".png");
        chat_item.querySelector('#Image').src = "/public/avatar" + eval(1 + (id % chat_img_length)) + ".png";
